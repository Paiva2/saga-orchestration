...
public class KafkaTopicConfig {
    ...
    @Bean
    public NewTopic entryTopic() {
        Map<String, String> topicConfigs = new HashMap<>() {{
            put(org.apache.kafka.common.config.TopicConfig.RETENTION_MS_CONFIG, MESSAGES_RETENTION_DEFAULT_MILLIS_THREE_DAYS);
        }};

        return mountTopic(orchestratorTopic, topicConfigs);
    }
