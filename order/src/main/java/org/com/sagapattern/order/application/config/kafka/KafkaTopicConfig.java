...
public class KafkaTopicConfig {
    ...
    @Value("${spring.kafka.topic.order-ending-success}")
    private String orderEndingSuccess;

    @Value("${spring.kafka.topic.order-ending-fail}")
    private String orderEndingFail;
    ...
    @Bean
    public NewTopic orderEndingSuccess() {
        Map<String, String> topicConfigs = new HashMap<>() {{
            put(TopicConfig.RETENTION_MS_CONFIG, MESSAGES_RETENTION_DEFAULT_MILLIS_THREE_DAYS);
        }};

        return mountTopic(orderEndingSuccess, topicConfigs);
    }

    @Bean
    public NewTopic orderEndingFail() {
        Map<String, String> topicConfigs = new HashMap<>() {{
            put(TopicConfig.RETENTION_MS_CONFIG, MESSAGES_RETENTION_DEFAULT_MILLIS_THREE_DAYS);
        }};

        return mountTopic(orderEndingFail, topicConfigs);
    }
